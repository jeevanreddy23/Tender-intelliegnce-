...
test("keeps starter-only code out of the product surface", async () => {
  ...
  assert.equal(strategicSnapshot.winLossValidation.hypothesesGenerated, 564);
  ...
  assert.equal(strategicSnapshot.winLossValidation.verdictCounts.insufficientEvidence, 564);
