...
The checked-in strategic snapshot represents 143 award-only records. It does
...
audit therefore generates 572 hypotheses, runs zero NLI evaluations, and marks
all 572 `INSUFFICIENT_EVIDENCE`.

The raw 143-record dataset is not checked into this repository. Rebuilding
